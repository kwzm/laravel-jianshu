<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="sidebar">
    <aside class="widget panel panel-default" id="widget-welcome">
    ...
    <aside class="widget panel panel-default" id="widget-categories">
        <div class="panel-heading">
            专题
        </div>
